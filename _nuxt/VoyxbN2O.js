 ...
 * limitations under the License.
 * =============================================================================
 */const Te=Ts("kernelRegistry",()=>new Map),We=Ts("gradRegistry",()=>new Map);function Ue(e,t){const n=Fs(e,t);return Te.get(n)}function es(e){return We.get(e)}function yn(e){const t=Te.entries(),n=[];for(;;){const{done:s,value:r}=t.next();if(s)break;const[o,a]=r,[i]=o.split("_");i===e&&n.push(a)}return n}function Bi(e){const{kernelName:t,backendName:n}=e,s=Fs(t,n);Te.has(s)&&Lt(`The kernel '${t}' for backend '${n}' is already registered`),Te.set(s,e)}function Eu(e){const{kernelName:t}=e;We.has(t)&&N().getBool("DEBUG")&&Lt(`Overriding the gradient for '${t}'`),We.set(t,e)}function ku(e,t){const n=Fs(e,t);if(!Te.has(n))throw new Error(`The kernel '${e}' for backend '${t}' is not registered`);Te.delete(n)}function Su(e){if(!We.has(e))throw new Error(`The gradient '${e}' for backend is not registered`);We.delete(e)}function xu(e,t){yn(e).forEach(s=>{const r=Object.assign({},s,{backendName:t});Bi(r)})}function Fs(e,t){return`${t}_${e}`}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function vf(e){const n={x:f(e,"x","asinh")};return m.runKernel(Qr,n)}const If=g({asinh_:vf});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */function Kd(e,t,n="NHWC"){const s=f(e,"x","depthToSpace","float32"),r=n==="NHWC"?s.shape[1]:s.shape[2],o=n==="NHWC"?s.shape[2]:s.shape[3],a=n==="NHWC"?s.shape[3]:s.shape[1];p(t>1,()=>`blockSize should be > 1 for depthToSpace, but was: ${t}`),p(r*t>=0,()=>`Negative dimension size caused by overflow when multiplying
    ...
    ${o} and ${t} for depthToSpace with input shape
        ${s.shape}`),p(a%(t*t)===0,()=>`Dimension size must be evenly divisible by ${t*t} but is ${a} for depthToSpace with input shape ${s.shape}`);const i={x:s},c={blockSize:t,dataFormat:n};return m.runKernel(To,i,c)}const Vd=g({depthToSpace_:Kd});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Tp(e,t=0){const n=f(e,"x","expandDims","string_or_numeric");p(t<=n.rank,()=>"Axis must be <= rank of the tensor");const s={input:n},r={dim:t};return m.runKernel(Lo,s,r)}const Ot=g({expandDims_:Tp});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */function Hp(e,t=5,n=1,s=1,r=.5){const o=f(e,"x","localResponseNormalization");p(o.rank===4||o.rank===3,()=>`Error in localResponseNormalization: x must be rank 3 or 4 but got
               rank ${o.rank}.`),p(Ie(t),()=>`Error in localResponseNormalization: depthRadius must be an integer but got depthRadius ${t}.`);let a=o,i=!1;o.rank===3&&(i=!0,a=E(o,[1,o.shape[0],o.shape[1],o.shape[2]]));const c={x:a},l={depthRadius:t,bias:n,alpha:s,beta:r},h=m.runKernel(ha,c,l);return i?E(h,[h.shape[1],h.shape[2],h.shape[3]]):h}const jp=g({localResponseNormalization_:Hp});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Tg(e,t){let n=f(e,"a","mod"),s=f(t,"b","mod");[n,s]=X(n,s);const r={a:n,b:s};return m.runKernel(Ea,r)}const _g=g({mod_:Tg});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yg(e,t,n,s,r,o,a){r==null&&(r=[1,1]),o==null&&(o=1),s===0&&(s="valid");const i=f(e,"x","maxPool");let c=i,l=!1;i.rank===3&&(l=!0,c=E(i,[1,i.shape[0],i.shape[1],i.shape[2]])),p(Ct(o,r),()=>`Error in pool: Either strides or dilations must be 1. Got strides ${o} and dilations '${r}'`);const h=mc(c.shape,t,o,r,s),u=[h.dilationHeight,h.dilationWidth];let d;s==="same"?d=Qg([h.filterHeight,h.filterWidth],u):d=[[0,0],[0,0]];const b=u[0]===1&&u[1]===1,[w,$]=Jg([h.inHeight,h.inWidth],u,d),y=b?s:"valid",S=b?c:qc(c,u,w),k=(n==="avg"?()=>yc(S,t,o,y,a):()=>Lc(S,t,o,y,a))(),I=b?k:$c(k,u,$);return l?E(I,[I.shape[1],I.shape[2],I.shape[3]]):I}function Jg(e,t,n){const s=n.map(h=>h[0]),r=n.map(h=>h[1]),o=e.concat(s,r),a=t.map((h,u)=>(h-o[u]%h)%h),i=r.map((h,u)=>h+a[u]),c=t.map((h,u)=>[s[u],i[u]]),l=t.map((h,u)=>[0,a[u]]);return[c,l]}function Qg(e,t){const s=e.map((a,i)=>a+(a-1)*(t[i]-1)).map(a=>a-1),r=s.map(a=>Math.floor(a/2)),o=s.map((a,i)=>a-r[i]);return s.map((a,i)=>[r[i],o[i]])}const tm=g({pool_:Yg});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Im(e,t=0,n=1,s,r){if(pt(e),s!=null&&s==="bool")throw new Error(`Unsupported data type ${s}`);const o=new Vs(t,n,s,!1,r),a=Ft(e,s);for(let i=0;i<a.values.length;i++)a.values[i]=o.nextValue();return a.toTensor()}const Vc=g({randomNormal_:Im});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function yb(e){const t=e.shape[e.shape.length-1],n=e.size/t;let s;if(t<=2){const r=E(e,[n,t]);s=In(r)}else{const r=[n,2*(t-1)],o=E(Ye(e),[n,t]),a=E(Cn(e),[n,t]),i=le(H(o,[0,1],[n,t-2]),1),c=v(le(H(a,[0,1],[n,t-2]),1),W(-1)),l=dt([o,i],1),h=dt([a,c],1),u=E(Ht(l,h),[r[0],r[1]]);s=In(u)}if(s=Ye(s),e.rank===3&&e.shape[0]!==0){const r=s,o=e.shape[0];s=E(s,[o,s.shape[0]/o,s.shape[1]]),r.dispose()}return s}const Xc=g({irfft_:yb});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ib(e,t,n,s,r=0,o=0,a=0,i=0,c=0){const h={x:f(e,"x","stridedSlice","string_or_numeric")},u={begin:t,end:n,strides:s,beginMask:r,endMask:o,ellipsisMask:a,newAxisMask:i,shrinkAxisMask:c};return m.runKernel(yi,h,u)}const Tb=g({stridedSlice_:Ib});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qb(e,t,n){const s=f(e,"x","unsortedSegmentSum"),r=f(t,"segmentIds","unsortedSegmentSum","int32");p(Ie(n),()=>"numSegments must be of dtype int");const o={x:s,segmentIds:r},a={numSegments:n};return m.runKernel(Di,o,a)}const Gb=g({unsortedSegmentSum_:qb});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function dw({x:e,filter:t,strides:n,pad:s,dataFormat:r="NHWC",dilations:o=[1,1],dimRoundingMode:a,bias:i,activation:c="linear",preluActivationWeights:l,leakyreluAlpha:h}){if(c=c||"linear",Gn(m.state.gradientDepth,c)===!1){p(r==="NHWC",()=>`Error in fused conv2d: got dataFormat of ${r} but only NHWC is currently supported for the case of gradient depth is 0 and the activation is not linear.`);let T=Fn(e,t,n,s,r,o,a);return i!=null&&(T=A(T,i)),qn(T,c,l,h)}const u=f(e,"x","conv2d","float32"),d=f(t,"filter","conv2d","float32");let b=u,w=!1;u.rank===3&&(w=!0,b=E(u,[1,u.shape[0],u.shape[1],u.shape[2]])),p(b.rank===4,()=>`Error in fused conv2d: input must be rank 4, but got rank ${b.rank}.`),p(d.rank===4,()=>`Error in fused conv2d: filter must be rank 4, but got rank ${d.rank}.`),kt("fused conv2d",s,a);const $=r==="NHWC"?b.shape[3]:b.shape[1];p(d.shape[2]===$,()=>`Error in conv2d: depth of input (${$}) must match input depth for filter ${d.shape[2]}.`),p(Ct(n,o),()=>`Error in conv2D: Either strides or dilations must be 1. Got strides ${n} and dilations '${o}'`);const y=on(b.shape,d.shape,n,o,s,a);let S;i!=null&&(S=f(i,"bias","fused conv2d"),[S]=X(S,u),r==="NHWC"?J(y.outShape,S.shape):(p(S.shape.length<=1,()=>`Error in fused conv2d: only supports scalar or 1-D Tensor bias for NCHW format but got the bias of rank-${S.shape.length}.`),p(S.shape.length===0||S.shape[0]===y.outChannels||S.shape[0]===1,()=>`Error in fused conv2d: bias shape (${S.shape}) is not compatible with the number of output channels (${y.outChannels})`)));let D;if(l!=null){const T=l.shape;if(p(T.length<=1||T.length===3,()=>`Error in fused conv2d: only supports scalar, 1-D Tensor or 3-D Tensor PReLU activation weights but got a tensor of rank-${T.length}.`),T.length===1)p(T[0]===1||T[0]===y.outChannels,()=>`Error in fused conv2d: PReLU activation weights (${T}) is not compatible with the number of output channels (${y.outChannels}).`);else if(T.length===3)try{J(T,y.outShape)}catch{const B=`Error in fused conv2d: PReLU activation weights (${T}) is not compatible with the output shape of the conv2d (${y.outShape}).`;throw Error(B)}D=f(l,"prelu weights","fused conv2d")}const k=(T,R)=>{p(r==="NHWC",()=>`Error in gradient of fused conv2D: got dataFormat of ${r} but only NHWC is currently supported.`);const[B,M,P,C]=R,Q=Wn(T,P,c);p(He(o),()=>`Error in gradient of fused conv2D: dilation rates greater than 1 are not yet supported in gradients. Got dilations '${o}'`);const nt=kc(M.shape,Q,B,n,s),st=fw(M,Q,B.shape,n,s),ut=[nt,st];if(C!=null){const de=Un(C,Q);ut.push(de)}return ut},I={x:b,filter:d,bias:S,preluActivationWeights:D},_={strides:n,pad:s,dataFormat:r,dilations:o,dimRoundingMode:a,activation:c,leakyreluAlpha:h};return i==null?Dt((R,B,M)=>{let P=m.runKernel(Qn,I,_);return M([B,R,P]),w&&(P=E(P,[P.shape[1],P.shape[2],P.shape[3]])),{value:P,gradFunc:k}})(b,d):Dt((R,B,M,P)=>{let C=m.runKernel(Qn,I,_);return P([B,R,C,M]),w&&(C=E(C,[C.shape[1],C.shape[2],C.shape[3]])),{value:C,gradFunc:k}})(b,d,S)}const pw=g({fusedConv2d_:dw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function yw({x:e,filter:t,strides:n,pad:s,dataFormat:r="NHWC",dilations:o=[1,1],dimRoundingMode:a,bias:i,activation:c="linear",preluActivationWeights:l,leakyreluAlpha:h}){if(Gn(m.state.gradientDepth,c)===!1){let _=Ls(e,t,n,s,r,o,a);return i!=null&&(_=A(_,i)),qn(_,c,l,h)}const u=f(e,"x","depthwiseConv2d","float32"),d=f(t,"filter","depthwiseConv2d","float32");let b=u,w=!1;u.rank===3&&(w=!0,b=E(u,[1,u.shape[0],u.shape[1],u.shape[2]])),p(b.rank===4,()=>`Error in fused depthwiseConv2d: input must be rank 4, but got rank ${b.rank}.`),p(d.rank===4,()=>`Error in fused depthwiseConv2d: filter must be rank 4, but got rank ${d.rank}.`),p(b.shape[3]===d.shape[2],()=>`Error in fused depthwiseConv2d: number of input channels (${b.shape[3]}) must match the inChannels dimension in filter ${d.shape[2]}.`),o==null&&(o=[1,1]),p(Ct(n,o),()=>`Error in fused depthwiseConv2d: Either strides or dilations must be 1. Got strides ${n} and dilations '${o}'`),kt("fused depthwiseConv2d",s,a);const $=on(b.shape,d.shape,n,o,s,a,!0);let y;i!=null&&(y=f(i,"bias","fused conv2d"),[y]=X(y,u),J($.outShape,y.shape));let S;l!=null&&(S=f(l,"prelu weights","fused depthwiseConv2d"));const D=(_,T)=>{p(He(o),()=>`Error in gradient of fused depthwiseConv2d: dilation rates greater than 1 are not yet supported. Got dilations '${o}'`);const[R,B,M,P]=T,C=Wn(_,M,c),Q=ww(B.shape,C,R,n,s,o,a),nt=mw(B,C,R.shape,n,s,o,a);if(P!=null){const st=Un(y,C);return[Q,nt,st]}return[Q,nt]},k={x:b,filter:d,bias:y,preluActivationWeights:S},I={strides:n,pad:s,dataFormat:r,dilations:o,dimRoundingMode:a,activation:c,leakyreluAlpha:h};return i==null?Dt((T,R,B)=>{let M=m.runKernel(ts,k,I);return B([R,T,M]),w&&(M=E(M,[M.shape[1],M.shape[2],M.shape[3]])),{value:M,gradFunc:D}})(b,d):Dt((T,R,B,M)=>{let P=m.runKernel(ts,k,I);return M([R,T,P,B]),w&&(P=E(P,[P.shape[1],P.shape[2],P.shape[3]])),{value:P,gradFunc:D}})(b,d,y)}const $w=g({fusedDepthwiseConv2d_:yw});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ew({a:e,b:t,transposeA:n=!1,transposeB:s=!1,bias:r,activation:o="linear",preluActivationWeights:a,leakyreluAlpha:i=.2}){if(Gn(m.state.gradientDepth,o)===!1){let C=O(e,t,n,s);return r!=null&&(C=A(C,r)),qn(C,o,a,i)}let c=f(e,"a","fused matMul"),l=f(t,"b","fused matMul");[c,l]=X(c,l);const h=n?c.shape[c.rank-2]:c.shape[c.rank-1],u=s?l.shape[l.rank-1]:l.shape[l.rank-2],d=n?c.shape[c.rank-1]:c.shape[c.rank-2],b=s?l.shape[l.rank-2]:l.shape[l.rank-1],w=c.shape.slice(0,-2),$=l.shape.slice(0,-2),y=L(w),S=L($);p(h===u,()=>`Error in fused matMul: inner shapes (${h}) and (${u}) of Tensors with shapes ${c.shape} and ${l.shape} and transposeA=${n} and transposeB=${s} must match.`);const k=J(c.shape.slice(0,-2),l.shape.slice(0,-2)).concat([d,b]),I=n?E(c,[y,h,d]):E(c,[y,d,h]),_=s?E(l,[S,b,u]):E(l,[S,u,b]);let T;r!=null&&(T=f(r,"bias","fused matMul"),[T]=X(T,c),J(k,T.shape));let R;a!=null&&(R=f(a,"prelu weights","fused matMul"));const B=(C,Q)=>{const[nt,st,ut,de]=Q,Nt=Wn(E(C,ut.shape),ut,o);let pe,ge;if(!n&&!s?(pe=O(Nt,st,!1,!0),ge=O(nt,Nt,!0,!1)):!n&&s?(pe=O(Nt,st,!1,!1),ge=O(Nt,nt,!0,!1)):n&&!s?(pe=O(st,Nt,!1,!0),ge=O(nt,Nt,!1,!1)):(pe=O(st,Nt,!0,!0),ge=O(Nt,nt,!0,!0)),r!=null){const _l=Un(de,Nt);return[pe,ge,_l]}else return[pe,ge]},M={a:I,b:_,bias:T,preluActivationWeights:R},P={transposeA:n,transposeB:s,activation:o,leakyreluAlpha:i};return r==null?Dt((Q,nt,st)=>{const ut=m.runKernel(Jn,M,P);return st([Q,nt,ut]),{value:E(ut,k),gradFunc:B}})(I,_):Dt((Q,nt,st,ut)=>{const de=m.runKernel(Jn,M,P);return ut([Q,nt,de,st]),{value:E(de,k),gradFunc:B}})(I,_,T)}const kw=g({fusedMatMul_:Ew});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Iw(e){return Qs(e,.5,.5)}const sl=g({hannWindow_:Iw});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Tw(e,t,n,s=!1,r=0){let o=0;const a=[];for(;o+t<=e.size;)a.push(H(e,o,t)),o+=n;if(s)for(;o<e.size;){const i=o+t-e.size,c=dt([H(e,o,t-i),an([i],r)]);a.push(c),o+=n}return a.length===0?Oe([],[0,t]):E(dt(a),[a.length,t])}const rl=g({frame_:Tw});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function by(e,t=!1){if(p(e.rank>=2,()=>`qr() requires input tensor to have a rank >= 2, but got rank ${e.rank}`),e.rank===2)return xr(e,t);{const n=e.shape.slice(0,e.shape.length-2).reduce((c,l)=>c*l),s=Js(E(e,[n,e.shape[e.shape.length-2],e.shape[e.shape.length-1]]),0),r=[],o=[];s.forEach(c=>{const[l,h]=xr(c,t);r.push(l),o.push(h)});const a=E(Qe(r,0),e.shape),i=E(Qe(o,0),e.shape);return[a,i]}}function xr(e,t=!1){return m.tidy(()=>{p(e.shape.length===2,()=>`qr2d() requires a 2D Tensor, but got a ${e.shape.length}D Tensor.`);const n=e.shape[0],s=e.shape[1];let r=_c(n),o=se(e);const a=Oe([[1]],[1,1]);let i=se(a);const c=n>=s?s:n;for(let l=0;l<c;++l){const h=o,u=i,d=r;[i,o,r]=m.tidy(()=>{const b=H(o,[l,l],[n-l,1]),w=Bn(b),$=H(o,[l,l],[1,1]),y=zt(Rn($,0),Oe([[-1]]),Oe([[1]])),S=F($,v(y,w)),D=G(b,S);D.shape[0]===1?i=se(a):i=dt([a,H(D,[1,0],[D.shape[0]-1,D.shape[1]])],0);const k=_t(G(O(y,S),w)),I=H(o,[l,0],[n-l,s]),_=v(k,i),T=Tn(i);if(l===0)o=F(I,O(_,O(T,I)));else{const M=F(I,O(_,O(T,I)));o=dt([H(o,[0,0],[l,s]),M],0)}const R=Tn(_),B=H(r,[0,l],[n,r.shape[1]-l]);if(l===0)r=F(B,O(O(B,i),R));else{const M=F(B,O(O(B,i),R));r=dt([H(r,[0,0],[n,l]),M],1)}return[i,o,r]}),ct([h,u,d])}return!t&&n>s&&(r=H(r,[0,0],[n,s]),o=H(o,[0,0],[s,s])),[r,o]})}const wy=g({qr_:by});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Iy(e,t,n,s=1,r=at.SUM_BY_NONZERO_WEIGHTS){const o=f(e,"labels","huberLoss"),a=f(t,"predictions","huberLoss");let i=null;n!=null&&(i=f(n,"weights","huberLoss")),it(o.shape,a.shape,"Error in huberLoss: ");const c=W(s),l=mt(F(a,o)),h=vn(l,c),u=F(l,h),d=A(v(W(.5),xt(h)),v(c,u));return Pt(d,i,r)}const Ty=g({huberLoss_:Iy});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const t1={fft:js,ifft:In,rfft:Xs,irfft:Xc},e1={hammingWindow:vw,hannWindow:sl,frame:rl,stft:Aw},n1={flipLeftRight:Fw,grayscaleToRGB:Rw,resizeNearestNeighbor:iy,resizeBilinear:oy,rgbToGrayscale:Pw,rotateWithOffset:Lw,cropAndResize:Nw,nonMaxSuppression:Uw,nonMaxSuppressionAsync:Xw,nonMaxSuppressionWithScore:Yw,nonMaxSuppressionWithScoreAsync:Qw,nonMaxSuppressionPadded:ey,nonMaxSuppressionPaddedAsync:sy,threshold:uy,transform:fy},s1={bandPart:py,gramSchmidt:my,qr:wy},r1={absoluteDifference:Ey,computeWeightedLoss:Pt,cosineDistance:Sy,hingeLoss:vy,huberLoss:Ty,logLoss:Ay,meanSquaredError:Ny,sigmoidCrossEntropy:By,softmaxCrossEntropy:Py},o1={sparseFillEmptyRows:Ly,sparseReshape:Uy,sparseSegmentMean:Gy,sparseSegmentSum:Ky},a1={stringNGrams:Hy,stringSplit:Xy,stringToHashBucketFast:Yy,staticRegexReplace:Qy};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Xn{constructor(t){this.modelArtifacts=t}load(){return this.modelArtifacts}}class dl{constructor(t){this.saveHandler=t}save(t){return this.saveHandler(t)}}class v1{constructor(t){t.load&&(this.load=()=>Promise.resolve(t.load())),t.save&&(this.save=n=>Promise.resolve(t.save(n)))}}function I1(e,t,n,s){const r=arguments;return new v1(pl(...r))}function pl(e,t,n,s){return arguments.length===1?e.modelTopology!=null||e.weightSpecs!=null?new Xn(e):(console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."),new Xn({modelTopology:e})):(console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."),new Xn({modelTopology:e,weightSpecs:t,weightData:n,trainingConfig:s}))}function T1(e){return new dl(e)}function _1(e){return new dl(e)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var Tt;(function(e){e[e.FIRST_DIM_SIZE=0]="FIRST_DIM_SIZE",e[e.VALUE_ROWIDS=1]="VALUE_ROWIDS",e[e.ROW_LENGTHS=2]="ROW_LENGTHS",e[e.ROW_SPLITS=3]="ROW_SPLITS",e[e.ROW_LIMITS=4]="ROW_LIMITS",e[e.ROW_STARTS=5]="ROW_STARTS"})(Tt||(Tt={}));function a0(e,t,n){let s=new Array;if(n==null&&t==null)return s;if(t==null)for(;s.length<e+n.length;)s.push(-1);else s=t.slice();if(n==null)return s;if(e+n.length!==s.length)throw new Error(`rt input.shape and shape=${t} are incompatible: rt input.rank = ${e+n.length}, but shape.rank = ${s.length}`);for(let r=1;r<n.length;++r){const o=n[r],a=s[s.length-n.length+r],i=s[a];if(o>=0)if(i>=0){if(i!==o)throw new Error(`rt input.shape and shape=${t} are incompatible: rt input.shape[${r+e}] = ${o} but shape[${r+e}] = ${i}`)}else s[a]=o}return s}function i0(e){const t={FIRST_DIM_SIZE:Tt.FIRST_DIM_SIZE,VALUE_ROWIDS:Tt.VALUE_ROWIDS,ROW_LENGTHS:Tt.ROW_LENGTHS,ROW_SPLITS:Tt.ROW_SPLITS,ROW_LIMITS:Tt.ROW_LIMITS,ROW_STARTS:Tt.ROW_STARTS},n=[];for(const s of e)if(s in t)n.push(t[s]);else break;return n}function c0(e){return e.length===0?0:e[0]===Tt.FIRST_DIM_SIZE?e.length-1:e.length}function l0(e,t){if(e==null||t==null)return;const n=e.length,s=t.length;if(n>=s)throw new Error(`defaultValue.shape=${e} and ragged tensor flatValues.shape=${t}, are incompatible: defaultValue.rank = ${n} must be less than ragged tensor input flatValues.rank = ${s})`);for(let r=0;r<Math.min(n,s-1);++r){const o=e[r],a=t[r+1];if(o>=0&&a>=0&&o!==1&&o!==a)throw new Error(`defaultValue.shape=${e}, and ragged tensor input flatValues.shape=${t} are incompatible: defaultValue.shape[${r-e.length}] = ${o} but ragged tensor input.flatValues.shape[${r-e.length}] = ${a}`)}}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function v0(e,t){if(e.length!==t.length)throw new Error(`Cannot merge real and imag arrays of different lengths. real:${e.length}, imag: ${t.length}.`);const n=new Float32Array(e.length*2);for(let s=0;s<n.length;s+=2)n[s]=e[s/2],n[s+1]=t[s/2];return n}function I0(e){const t=new Float32Array(e.length/2),n=new Float32Array(e.length/2);for(let s=0;s<e.length;s+=2)t[s/2]=e[s],n[s/2]=e[s+1];return{real:t,imag:n}}function T0(e){const t=Math.ceil(e.length/4),n=new Float32Array(t),s=new Float32Array(t);for(let r=0;r<e.length;r+=4)n[Math.floor(r/4)]=e[r],s[Math.floor(r/4)]=e[r+1];return{real:n,imag:s}}function _0(e){const t=Math.floor(e.length/4),n=new Float32Array(t),s=new Float32Array(t);for(let r=2;r<e.length;r+=4)n[Math.floor(r/4)]=e[r],s[Math.floor(r/4)]=e[r+1];return{real:n,imag:s}}function A0(e,t){const n=e[t*2],s=e[t*2+1];return{real:n,imag:s}}function D0(e,t,n,s){e[s*2]=t,e[s*2+1]=n}function N0(e,t){const n=new Float32Array(e/2),s=new Float32Array(e/2);for(let r=0;r<Math.ceil(e/2);r++){const o=(t?2:-2)*Math.PI*(r/e);n[r]=Math.cos(o),s[r]=Math.sin(o)}return{real:n,imag:s}}function M0(e,t,n){const s=(n?2:-2)*Math.PI*(e/t),r=Math.cos(s),o=Math.sin(s);return{real:r,imag:o}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */h1();const l$=Object.freeze(Object.defineProperty({__proto__:null,Abs:zr,Acos:Kr,Acosh:Vr,AdadeltaOptimizer:er,AdagradOptimizer:nr,AdamOptimizer:sr,AdamaxOptimizer:rr,Add:_s,AddN:Hr,All:jr,Any:Xr,ArgMax:Zr,ArgMin:Yr,Asin:Jr,Asinh:Qr,Atan:to,Atan2:no,Atanh:eo,AvgPool:so,AvgPool3D:ro,AvgPool3DGrad:nu,AvgPoolGrad:eu,BatchMatMul:oo,BatchToSpaceND:ao,Bincount:io,BitwiseAnd:co,BroadcastArgs:lo,BroadcastTo:su,Cast:As,Ceil:uo,ClipByValue:ho,Complex:fo,ComplexAbs:po,Concat:go,Conv2D:mo,Conv2DBackpropFilter:bo,Conv2DBackpropInput:wo,Conv3D:yo,Conv3DBackpropFilterV2:ru,Conv3DBackpropInputV2:$o,Cos:Eo,Cosh:ko,CropAndResize:vo,Cumprod:So,Cumsum:xo,DataStorage:Fl,DenseBincount:Io,DepthToSpace:To,DepthwiseConv2dNative:_o,DepthwiseConv2dNativeBackpropFilter:Ao,DepthwiseConv2dNativeBackpropInput:Do,Diag:No,Dilation2D:Mo,Dilation2DBackpropFilter:au,Dilation2DBackpropInput:ou,Draw:Ds,get ENV(){return Is},Einsum:Bo,Elu:Ro,EluGrad:iu,Environment:qr,Equal:Po,Erf:Co,Exp:Oo,ExpandDims:Lo,Expm1:Wo,FFT:Uo,Fill:qo,FlipLeftRight:Go,Floor:zo,FloorDiv:Ko,FromPixels:Yn,FusedBatchNorm:Vo,FusedConv2D:Qn,FusedDepthwiseConv2D:ts,GatherNd:jo,GatherV2:Ho,Greater:Xo,GreaterEqual:Zo,IFFT:Yo,Identity:Ns,Imag:Jo,IsFinite:Qo,IsInf:ta,IsNan:ea,KernelBackend:Nr,LRN:ha,LRNGrad:hu,LeakyRelu:na,Less:sa,LessEqual:ra,LinSpace:oa,Log:aa,Log1p:ia,LogSoftmax:lu,LogicalAnd:ca,LogicalNot:la,LogicalOr:ua,LogicalXor:cu,LowerBound:uu,MatrixBandPart:fu,Max:fa,MaxPool:pa,MaxPool3D:ga,MaxPool3DGrad:pu,MaxPoolGrad:du,MaxPoolWithArgmax:ma,Maximum:da,Mean:ba,Min:wa,Minimum:ya,MirrorPad:$a,Mod:Ea,MomentumOptimizer:or,Multinomial:ka,Multiply:Sa,Neg:xa,NonMaxSuppressionV3:Ia,NonMaxSuppressionV4:Ta,NonMaxSuppressionV5:_a,NotEqual:va,OP_SCOPE_SUFFIX:Qi,OneHot:Da,OnesLike:Aa,Optimizer:Zt,OptimizerConstructors:Tl,Pack:Na,PadV2:Ma,Pool:gu,Pow:Fa,Prelu:Ba,Prod:Ra,RMSPropOptimizer:ar,RaggedGather:Ca,RaggedRange:Pa,RaggedTensorToTensor:Oa,Range:La,get Rank(){return rs},Real:Wa,RealDiv:Fo,Reciprocal:Ua,get Reduction(){return at},Relu:qa,Relu6:Va,Reshape:Ga,ResizeBilinear:Ka,ResizeBilinearGrad:bu,ResizeNearestNeighbor:za,ResizeNearestNeighborGrad:mu,Reverse:Ha,RotateWithOffset:Fi,Round:ja,Rsqrt:Xa,SGDOptimizer:zn,ScatterNd:Za,SearchSorted:Ja,Select:Qa,Selu:ti,Sigmoid:oi,Sign:ri,Sin:ni,Sinh:si,Slice:ei,Softmax:hi,Softplus:ai,SpaceToBatchND:li,SparseFillEmptyRows:fi,SparseReshape:di,SparseSegmentMean:pi,SparseSegmentSum:gi,SparseToDense:mi,SplitV:ui,Sqrt:ii,Square:wu,SquaredDifference:bi,StaticRegexReplace:wi,Step:Mi,StridedSlice:yi,StringNGrams:$i,StringSplit:Ei,StringToHashBucketFast:ki,Sub:Si,Sum:ci,Tan:xi,Tanh:vi,Tensor:Z,TensorBuffer:kn,TensorScatterUpdate:Ya,Tile:Ms,TopK:Ii,Transform:Ti,Transpose:fn,Unique:_i,Unpack:Ai,UnsortedSegmentSum:Di,UpperBound:yu,Variable:Ge,ZerosLike:Ni,_FusedMatMul:Jn,abs:mt,acos:uf,acosh:ff,add:A,addN:pf,all:mf,any:wf,argMax:$f,argMin:kf,asin:xf,asinh:If,atan:_f,atan2:Df,atanh:Mf,avgPool:yc,avgPool3d:qf,backend:nc,backend_util:o$,basicLSTMCell:Xf,batchNorm:Mn,batchNorm2d:td,batchNorm3d:nd,batchNorm4d:rd,batchToSpaceND:$c,bincount:Ec,bitwiseAnd:id,booleanMaskAsync:Xb,broadcastArgs:ld,broadcastTo:gn,broadcast_util:Jd,browser:q1,buffer:Ft,cast:V,ceil:fd,clipByValue:pd,clone:se,complex:Ht,concat:dt,concat1d:md,concat2d:wd,concat3d:$d,concat4d:kd,conv1d:vd,conv2d:Fn,conv2dTranspose:_d,conv3d:Dd,conv3dTranspose:Bd,copyRegisteredKernels:xu,cos:Cd,cosh:Od,cosineWindow:Qs,cumprod:Wd,cumsum:qd,customGrad:Dt,denseBincount:zd,deprecationWarn:ih,depthToSpace:Vd,depthwiseConv2d:Ls,device_util:eh,diag:Xd,dilation2d:Yd,disableDeprecationWarnings:ah,dispose:ct,disposeVariables:ch,div:G,divNoNan:sp,dot:op,dropout:cw,einsum:we,elu:vc,enableDebugMode:oh,enableProdMode:rh,enclosingPowerOfTwo:nl,engine:lh,ensureShape:lp,env:N,equal:xc,erf:hp,euclideanNorm:vp,exp:ce,expandDims:Ot,expm1:Ap,eye:_c,fft:js,fill:an,findBackend:mh,findBackendFactory:bh,floor:Ac,floorDiv:gc,fused:Sw,gather:Dc,gatherND:ow,gather_util:G1,getBackend:ec,getGradient:es,getKernel:Ue,getKernelsForBackend:yn,grad:Yp,grads:Jp,greater:Rn,greaterEqual:Nc,ifft:In,imag:Cn,image:n1,inTopKAsync:uw,io:A1,irfft:Xc,isFinite:Op,isInf:Wp,isNaN:qp,keep:tc,kernel_impls:a$,leakyRelu:Mc,less:bs,lessEqual:qs,linalg:s1,linspace:Vp,localResponseNormalization:jp,log:Xe,log1p:Fc,logSigmoid:rg,logSoftmax:ig,logSumExp:Cc,logicalAnd:Sn,logicalNot:Pc,logicalOr:Oc,logicalXor:dg,losses:r1,lowerBound:gg,matMul:O,math:M1,max:ve,maxPool:Lc,maxPool3d:wg,maxPoolWithArgmax:$g,maximum:Wc,mean:xn,memory:uh,meshgrid:Sg,min:ms,minimum:vn,mirrorPad:Ig,mod:_g,moments:Dg,movingAverage:Jb,mul:v,multiRNNCell:Mg,multinomial:Bg,neg:_t,nextFrame:s0,norm:Bn,notEqual:Uc,oneHot:ws,ones:ne,onesLike:Og,op:g,outerProduct:Wg,pad:ln,pad1d:Gg,pad2d:Kg,pad3d:Hg,pad4d:Xg,pool:tm,pow:je,prelu:Gc,print:pc,prod:sm,profile:hh,raggedGather:om,raggedRange:im,raggedTensorToTensor:lm,rand:hm,randomGamma:vm,randomNormal:Vc,randomStandardNormal:_m,randomUniform:Hs,randomUniformInt:Nm,range:Ze,ready:ph,real:Ye,reciprocal:Bm,registerBackend:wh,registerGradient:Eu,registerKernel:Bi,relu:On,relu6:Hc,removeBackend:gh,reshape:E,reverse:le,reverse1d:Lm,reverse2d:Um,reverse3d:Gm,reverse4d:Km,rfft:Xs,round:jc,rsqrt:jm,scalar:W,scatterND:tw,scatter_util:Fb,searchSorted:Gs,selu:Zm,separableConv2d:Jm,serialization:l1,setBackend:dh,setPlatform:yh,setdiff1dAsync:tb,sigmoid:xe,sign:nb,signal:e1,sin:rb,sinh:ab,slice:H,slice1d:cb,slice2d:ub,slice3d:fb,slice4d:pb,slice_util:Il,softmax:mb,softplus:Rc,spaceToBatchND:qc,sparse:o1,sparseToDense:sw,spectral:t1,split:Je,sqrt:Bt,square:xt,squaredDifference:Zc,squeeze:Zs,stack:Qe,step:Yc,stridedSlice:Tb,string:a1,sub:F,sum:q,sumOutType:Vu,tan:Ab,tanh:gs,tensor:Ee,tensor1d:Et,tensor2d:Oe,tensor3d:Jc,tensor4d:Db,tensor5d:Nb,tensor6d:Mb,tensorScatterUpdate:Rb,tensor_util:Xu,test_util:Em,tidy:Y,tile:Pe,time:fh,topk:Pb,train:e0,transpose:Tn,truncatedNormal:Lb,unique:Ub,unregisterGradient:Su,unregisterKernel:ku,unsortedSegmentSum:Gb,unstack:Js,upcastType:Nn,upperBound:Kb,util:Ru,valueAndGrad:Qp,valueAndGrads:tg,variable:Vb,variableGrads:Bc,version_core:t0,where:zt,whereAsync:el,zeros:De,zerosLike:bt},Symbol.toStringTag,{value:"Module"}));export{nu as $,Kr as A,oo as B,dp as C,Fl as D,Ro as E,fp as F,_n as G,cn as H,Xr as I,Zr as J,Nr as K,na as L,Yr as M,Jr as N,Qr as O,Ba as P,to as Q,qa as R,no as S,eo as T,so as U,Ct as V,mc as W,Rt as X,ro as Y,Bf as Z,Jn as _,N as a,x0 as a$,eu as a0,Vo as a1,ao as a2,f0 as a3,d0 as a4,p0 as a5,g0 as a6,m0 as a7,io as a8,lo as a9,_o as aA,Ao as aB,Do as aC,No as aD,Mo as aE,Ff as aF,xs as aG,jl as aH,Dn as aI,au as aJ,$e as aK,Hl as aL,ou as aM,Ds as aN,ci as aO,Bo as aP,B0 as aQ,C0 as aR,P0 as aS,R0 as aT,O0 as aU,iu as aV,Co as aW,$0 as aX,E0 as aY,k0 as aZ,S0 as a_,ho as aa,po as ab,Jo as ac,go as ad,r0 as ae,o0 as af,mo as ag,wc as ah,on as ai,kn as aj,bo as ak,wo as al,yo as am,bc as an,ru as ao,$o as ap,Eo as aq,ko as ar,vo as as,So as at,Nn as au,vs as av,gp as aw,xo as ax,Io as ay,To as az,sn as b,Ka as b$,y0 as b0,Lo as b1,Fo as b2,A0 as b3,Mu as b4,I0 as b5,T0 as b6,_0 as b7,N0 as b8,D0 as b9,du as bA,ma as bB,ba as bC,wa as bD,$a as bE,Xl as bF,Ea as bG,hi as bH,ka as bI,Ia as bJ,ol as bK,Ta as bL,al as bM,_a as bN,il as bO,Da as bP,Ni as bQ,Aa as bR,Na as bS,it as bT,Ma as bU,Fa as bV,Ca as bW,Pa as bX,Oa as bY,La as bZ,Ua as b_,M0 as ba,Uo as bb,qo as bc,en as bd,Go as be,Qn as bf,ts as bg,jo as bh,bl as bi,Ho as bj,e$ as bk,Yo as bl,Qo as bm,ta as bn,ea as bo,oa as bp,ia as bq,ca as br,la as bs,ua as bt,ha as bu,hu as bv,fa as bw,pa as bx,ga as by,pu as bz,Vl as c,sa as c$,bu as c0,za as c1,mu as c2,Ha as c3,Fi as c4,h0 as c5,ja as c6,Za as c7,Qc as c8,Ja as c9,Ya as cA,Ms as cB,Ii as cC,Ti as cD,Le as cE,_i as cF,Ai as cG,Di as cH,Bi as cI,zr as cJ,Sc as cK,fo as cL,Ns as cM,Wa as cN,As as cO,Kl as cP,s$ as cQ,_s as cR,co as cS,uo as cT,Po as cU,Oo as cV,Wo as cW,zo as cX,Ko as cY,Xo as cZ,Zo as c_,Qa as ca,ti as cb,b0 as cc,w0 as cd,ri as ce,ni as cf,si as cg,ai as ch,li as ci,fi as cj,di as ck,pi as cl,gi as cm,mi as cn,ui as co,W0 as cp,wu as cq,Mi as cr,yi as cs,J1 as ct,H1 as cu,$i as cv,Ei as cw,ki as cx,xi as cy,vi as cz,En as d,Q0 as d$,ra as d0,aa as d1,da as d2,ya as d3,Sa as d4,xa as d5,va as d6,fn as d7,Ra as d8,i0 as d9,Y0 as dA,J0 as dB,ii as dC,bi as dD,wi as dE,Nu as dF,Si as dG,mn as dH,Ul as dI,Ce as dJ,Rl as dK,Br as dL,th as dM,o$ as dN,Gl as dO,Vt as dP,Cl as dQ,W as dR,bn as dS,s0 as dT,Yi as dU,Ie as dV,u0 as dW,Vu as dX,De as dY,Yn as dZ,t$ as d_,c0 as da,l0 as db,a0 as dc,Y as dd,E as de,gn as df,Tt as dg,Xa as dh,oi as di,X1 as dj,Z1 as dk,r$ as dl,ei as dm,Y1 as dn,K1 as dp,U0 as dq,q0 as dr,G0 as ds,z0 as dt,K0 as du,V0 as dv,H0 as dw,j0 as dx,X0 as dy,Z0 as dz,lh as e,ce as e$,se as e0,Qi as e1,mt as e2,uf as e3,ff as e4,A as e5,pf as e6,mf as e7,wf as e8,$f as e9,kd as eA,vd as eB,Fn as eC,_d as eD,Dd as eE,Bd as eF,Cd as eG,Od as eH,Qs as eI,Wd as eJ,qd as eK,zd as eL,Vd as eM,Ls as eN,Xd as eO,Yd as eP,G as eQ,sp as eR,op as eS,cw as eT,we as eU,vc as eV,nl as eW,lp as eX,xc as eY,hp as eZ,vp as e_,kf as ea,xf as eb,If as ec,_f as ed,Df as ee,Mf as ef,yc as eg,qf as eh,Xf as ei,Mn as ej,td as ek,nd as el,rd as em,$c as en,Ec as eo,id as ep,Xb as eq,ld as er,V as es,fd as et,pd as eu,Ht as ev,dt as ew,md as ex,wd as ey,$d as ez,Ft as f,Gg as f$,Ot as f0,Ap as f1,_c as f2,js as f3,an as f4,Ac as f5,gc as f6,Sw as f7,Dc as f8,ow as f9,gg as fA,O as fB,ve as fC,Lc as fD,wg as fE,$g as fF,Wc as fG,xn as fH,Sg as fI,ms as fJ,vn as fK,Ig as fL,_g as fM,Dg as fN,Jb as fO,v as fP,Mg as fQ,Bg as fR,_t as fS,Bn as fT,Uc as fU,ws as fV,ne as fW,Og as fX,g as fY,Wg as fZ,ln as f_,Rn as fa,Nc as fb,In as fc,Cn as fd,n1 as fe,uw as ff,Xc as fg,Op as fh,Wp as fi,qp as fj,Mc as fk,bs as fl,qs as fm,s1 as fn,Vp as fo,jp as fp,Xe as fq,Fc as fr,rg as fs,ig as ft,Cc as fu,Sn as fv,Pc as fw,Oc as fx,dg as fy,r1 as fz,tl as g,gs as g$,Kg as g0,Hg as g1,Xg as g2,tm as g3,je as g4,Gc as g5,pc as g6,sm as g7,om as g8,im as g9,nb as gA,e1 as gB,rb as gC,ab as gD,H as gE,cb as gF,ub as gG,fb as gH,pb as gI,mb as gJ,Rc as gK,qc as gL,o1 as gM,sw as gN,t1 as gO,Je as gP,Bt as gQ,xt as gR,Zc as gS,Zs as gT,Qe as gU,Yc as gV,Tb as gW,a1 as gX,F as gY,q as gZ,Ab as g_,lm as ga,hm as gb,vm as gc,Vc as gd,_m as ge,Hs as gf,Nm as gg,Ze as gh,Ye as gi,Bm as gj,On as gk,Hc as gl,le as gm,Lm as gn,Um as go,Gm as gp,Km as gq,Xs as gr,jc as gs,jm as gt,tw as gu,Gs as gv,Zm as gw,Jm as gx,tb as gy,xe as gz,Rr as h,Ee as h0,Et as h1,Oe as h2,Jc as h3,Db as h4,Nb as h5,Mb as h6,Rb as h7,Pe as h8,Pb as h9,Tn as ha,Lb as hb,Ub as hc,Gb as hd,Js as he,Kb as hf,Vb as hg,zt as hh,el as hi,bt as hj,tc as hk,An as hl,A1 as hm,Sh as hn,Z as ho,ct as hp,Bu as hq,l$ as hr,Ut as i,Va as j,Ga as k,zl as l,v0 as m,qe as n,p as o,J as p,Ne as q,wh as r,L as s,Vr as t,Hr as u,jr as v,Lt as w,tn as x,pp as y,mp as z};
