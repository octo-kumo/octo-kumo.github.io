import { DataTexture, MathUtils, RepeatWrapping, ShaderMaterial, Texture, TextureLoader, Uniform, Vector2, Vector3 } from "three";
...
const dither = new Uniform<Texture | undefined>(undefined);
export const sunVisibility = new Uniform(1);
export const twilightTime = new Uniform(0);
export const twilightVisibility = new Uniform(0);
...
const stars = new Uniform<DataTexture | undefined>(undefined);
...
function Vector3ToStarMap(dir: Vector3, value: number[]) {
...
export function Start() {
    ...
    SetSkyboxUniforms = function (material: ShaderMaterial) {
