...
<template>
  <div>
    <el-card>
      <el-checkbox v-model="show[field]" v-for="field in fields">
        Show {{ field }}
      </el-checkbox>
    </el-card>
    <el-divider />
    <el-space wrap>
      <comparator-purchasable-item
...
const fields: (keyof IPurchasableItem)[] = [
  "name",
  "source",
  "price",
  "weight",
...
const show = reactive({ name: true, price: true } as {
  [key in keyof IPurchasableItem]?: boolean;
});
