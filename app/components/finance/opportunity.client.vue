...
<template>
  <div>
    ...
    <ul>
      <el-text tag="li">
        1 {{ form.pa }} for {{ Math.min(oc1a, oc2a).toFixed(2) }} ~
        {{ Math.max(oc1a, oc2a).toFixed(2) }} {{ form.pb }}
      </el-text>
      <el-text tag="li">
        1 {{ form.pb }} for {{ Math.min(oc1b, oc2b).toFixed(2) }} ~
        {{ Math.max(oc1b, oc2b).toFixed(2) }} {{ form.pa }}
      </el-text>
    </ul>
  </div>
</template>
