...
<template>
  ...
  <template v-if="docs && docs.length > 0">
    <el-tree class="max-w-full lg:max-w-prose lg:mx-a lg:w-prose text-base!" :current-node-key="path" node-key="_path"
      highlight-current auto-expand-parent :default-expanded-keys="[path]" :data="navigation!" :props="defaultProps">
